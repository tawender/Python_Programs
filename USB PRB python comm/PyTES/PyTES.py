...
#for tom's system(not sure which computer)
##sys.path.append(r'C:\apps\Python27\Lib')
##sys.path.append(r'C:\Program Files\Cameron Health\IVA 4.4.12')

#for running on toby's bsci computer
sys.path.append(r'C:\Python27\Lib')
sys.path.append(r'C:\Program Files (x86)\Cameron Health\IVA 4.4.11')
...
class PyScript(object):
    def __init__(self, optionsPath, buildNumber, logName, sn=None):
